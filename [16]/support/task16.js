module.exports = function() {
    ...
    this.Given(/^I have visited localhost SubService$/, function () {
      browser.url('http://192.168.1.123:4000/sub-service');
    });

  
    this.Then(/^I see page SubService and I see button "([^"]*)"$/, function (arg1) {
    ...
    this.Then(/^I see textfield "([^"]*)"$/, function (arg1) {
      browser.waitForExist('label='+arg1,10000);
   });
  ...
  this.Then(/^I see sub service "([^"]*)" and i click it$/, function (arg1) {

      browser.waitForExist('div='+arg1,10000);
      browser.click('div='+arg1);
      browser.click('div='+arg1);
  });

  this.Then(/^I see status is "([^"]*)" and I click it$/, function (arg1) {
      browser.waitForExist('td='+arg1,10000);
      browser.click('td='+arg1);
      browser.click('td='+arg1);
  });

  this.Then(/^I see the textfield "([^"]*)" and I update it with value "([^"]*)"$/, function (arg1, arg2) {
      browser.waitForExist('label='+arg1,10000);
      browser.setValue('input[data-reactid="'+arg2+'"]',arg1);
